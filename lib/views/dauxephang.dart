    ...
    return Scaffold(
        body:Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage('asset/battle_map_63.jpg'),
            fit: BoxFit.fill
            )
          ),
          child: Container(
              ...
              children: [
                Container(
                  child: Container(
                    ...
                    height: 130,
                    decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage('asset/huanpi_denglu_xuanfu.png'),
                      fit: BoxFit.fill)
                    ),
                    child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        Container(
                          child: Image(image: AssetImage('asset/mengjiang.png'),
                          fit: BoxFit.fill,),
                        ),
                        Container(
                          child: Text('Điểm số',
                ...
                Container(
                  ...
                  width: 600,
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage('asset/bg_gaiming.png'),
                    fit: BoxFit.fill)
                  ),
                ),
                Container(
                  ...
                  width: 350,
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage('asset/hd_kapai44.png'),
                    fit: BoxFit.fill)
                  ),
                  child: Column(
                    children: [
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              height: 50,
                              decoration: BoxDecoration(
                                image: DecorationImage(image: AssetImage('asset/zb_di2.png'),
                                fit: BoxFit.fill)
                              ),
                              child: Row(
                                children: [
