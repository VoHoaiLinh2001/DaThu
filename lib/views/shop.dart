                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                children: [
                                  Container(
                                    ...
                                    height: 100,
                                    child: Image(image: AssetImage('asset/reset.png'),
                                    fit: BoxFit.cover,
                                    ),
                                   ...
                                   Container(
                                    ...
                                    height: 100,
                                    child: Image(image: AssetImage('asset/phantram.png'),
                                    fit: BoxFit.cover,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 100,
                                    child: Image(image: AssetImage('asset/next.png'),
                                    fit: BoxFit.cover,
                                    ),
                                  ),
                              ],
                          ...
                          child: Row( mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                                  Container(
                                    ...
                                    child: Image(image: AssetImage('asset/zhucheng_beibao.png'),
                                    fit: BoxFit.cover,)
                                  ),
                                   Container(
                                    width: 100,
                                    ...
                                    child: Image(image: AssetImage('asset/zhucheng_liaotian.png'),
                                    fit: BoxFit.cover,)
                                  ),
                                  Container(
                                    width: 100,
