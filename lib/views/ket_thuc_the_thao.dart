...
class ket_thuc_the_thao extends StatefulWidget {
  const ket_thuc_the_thao({super.key});

  @override
  State<ket_thuc_the_thao> createState() => _ket_thuc_the_thao();
}

class _ket_thuc_the_thao extends State<ket_thuc_the_thao> {
  @override
  Widget build(BuildContext context) {
    question_controller_the_thao _qnController =
