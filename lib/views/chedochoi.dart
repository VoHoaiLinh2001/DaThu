    ...
    return Scaffold(
        body:Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage('asset/bg_lose.jpg'),
            fit: BoxFit.fill)
          ),
          child: Column(
            children: [
                      ...
                      padding: EdgeInsets.only(top: 30,left: 100),
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('asset/huanpi_gongyong_juqing_4.png'),
                            fit: BoxFit.fill)
                          ),
                          child: Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text('CHỌN CHẾ ĐỘ',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                            ],
                          ),
                    ),
                  ],
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(image: AssetImage('asset/button.png'),
                        fit: BoxFit.fill)
                      ),
                      child: TextButton(
                      child: Text('PHỤ BẢN',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black),),
                       onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: TextButton(
                      child: Text('XẾP HẠNG',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black),),
                       onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
